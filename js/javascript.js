...
window.addEventListener("scroll", function() {
    ...
    const expLogo  = document.querySelector(".expLogoNav");
...
/*----------------------------------- serviciosPaginas -----------------------------------*/
function guardiasBtn() {
    window.location.href ='./guardiasSeguridad.html';
}

function seguridadArmadaBtn() {
    window.location.href = './seguridadArmada.html';
}

function transporteEjecutivoBtn() {
    window.location.href = './transporteEjecutivo.html';
}

function unidadesBlindadasBtn() {
    window.location.href = './unidadesBlindadas.html';
}

function servicioK9Btn() {
    window.location.href = './servicioK9.html';
}

function seguridadElectronicaBtn() {
    window.location.href = './seguridadElectronica.html';
}

function analisisRiesgoBtn() {
    window.location.href = './analisisRiesgo.html';
}

function gestionProtocolosBtn() {
    window.location.href = './gestionProtocolos.html';
}
